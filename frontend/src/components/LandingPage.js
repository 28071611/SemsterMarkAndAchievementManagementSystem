...
const LandingPage = ({ setView, showAdminLock, setShowAdminLock, adminUsername, setAdminUsername, adminPassword, setAdminPassword, passError, setPassError, onAdminUnlock }) => {
  ...
  // Secret admin access: Ctrl+Shift+A or 5 taps on logo
  useEffect(() => {
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-between p-6">
      ...
      <div className="max-w-4xl w-full text-center space-y-12">
        <div className="space-y-4">
          <div
            ...
            className="w-20 h-20 bg-indigo-600 rounded-[2rem] flex items-center justify-center mx-auto shadow-2xl shadow-indigo-100 cursor-pointer active:scale-95 transition-transform"
          >
      ...
      <footer className="w-full py-8 text-center">
        <button
          ...
          className="text-slate-300 hover:text-slate-400 text-xs font-medium transition-colors"
        >
